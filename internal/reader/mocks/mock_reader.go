...
//
//	mockgen -source=internal/reader/reader.go -destination=internal/reader/mocks/mock_reader.go -package=mocks
//
...
func (m *MockReader) Read(ctx context.Context) (<-chan [][]string, <-chan error) {
	m.ctrl.T.Helper()
